...
function CustomTable({
  ...
  return (
    <div className="h-full bg-white rounded-lg shadow-sm p-4 sm:p-6 overflow-hidden grid grid-rows-[auto_1fr_auto] ">
      ...
      {/* Pagination */}
      <div className="shrink-0 flex flex-col sm:flex-row items-center justify-between gap-4 mt-4 text-sm text-gray-700">
        {/* Loading indicator */}
        {isLoading && (
